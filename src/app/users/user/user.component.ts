...
export class UserComponent implements OnInit,OnDestroy {
  ...
  ngOnInit() {
    ...
    // the URL gets updated but the View will not change as angular thinks why to relode the same page again
    // on which you are already present. So to update the view we need to inform angular that we need to 
    ...
    // the help of Observable .subscribe()
